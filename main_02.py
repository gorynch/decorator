'''Доработать параметризованный декоратор logger в коде ниже. Должен получиться
...
def logger(file_path):
    ...
    def __logger(old_function):
        ...
        def wrapper(*args, **kwargs):
            log_string = f'{datetime.now().date()},{datetime.now().time()},{old_function.__name__},{args},{kwargs},{old_function(*args, **kwargs)}\n'
